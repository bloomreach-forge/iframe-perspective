...
public class NewsDocument extends HippoDocument {
     ...
     */
    public final static String DOCUMENT_TYPE = "iframeprspectivdemo:newsdocument";
    ...
    private final static String AUTHOR = "iframeprspectivdemo:author";
    private final static String SOURCE = "iframeprspectivdemo:source";
